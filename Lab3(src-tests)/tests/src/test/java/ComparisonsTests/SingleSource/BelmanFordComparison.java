package ComparisonsTests.SingleSource;
...
public class BelmanFordComparison {
    ...
    public void test_10_10() throws FileNotFoundException {
        ...
        for(int i=0;i<10;i++){
            ...
            obj.chooseMethodOneSrc(2, source);
    ...
    public void test_10_100() throws FileNotFoundException {
        ...
        for(int i=0;i<10;i++){
            ...
            long end = System.nanoTime();
            avg += (end-start)/1000;
            System.out.println("Time for 10 nodes and 100 edges: " + (end-start)/1000 + " microseconds");
        }
