...
public class PerfectHashingNSquareMethodTest {

    @Test(timeout = 1000)
    public void testInsertingInteger(){
        PerfectHashingNSquareMethod<Integer> testObject = new PerfectHashingNSquareMethod<>();
        assertTrue(testObject.insert(1));
    }

    @Test(timeout = 1000)
    public void testInsertingString(){
        PerfectHashingNSquareMethod<String> testObject = new PerfectHashingNSquareMethod<>();
...
//        System.out.println(5000);
        ...
        System.out.println("resultSize space:" +" "+testObject.getUtilizedSpace());
    }
    ...
    public void testIdenticalNCharactersWithBatchInsert(){
        ...
        // return only 1 true and array.size-1 false
        // (only inserted the first element but could not insert the other array.size-1)
        PerfectHashingNSquareMethod<Character> testObject = new PerfectHashingNSquareMethod<>();
        int randomSize = generateRandomNumber(1, 1000);
